          ...
          <div className="xl:col-span-2 space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                {canOpenInterview && (
                  <Button variant="outline" className="w-full justify-start" onClick={setInterviewTab}>
                    <ClipboardList className="h-4 w-4 mr-2" />
                    Zobacz wyniki ankiety (wywiad dietetyczny)
                  </Button>
                )}
                {!canOpenInterview && (
                  <p className="text-xs text-muted-foreground">Brak wysłanego wywiadu (wywiad dietetyczny) dla tego profilu.</p>
                )}
              </CardContent>
            </Card>
