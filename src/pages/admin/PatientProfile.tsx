...
import { ArrowLeft, Plus, Upload, Send, MessageSquare, FileText, User, Phone, Mail } from "lucide-react";
...
const PatientProfile = () => {
  ...
  const fetchPatientData = async () => {
    ...
    try {
      ...
      // Get email from auth.users via edge function would be needed
      // For now, we'll leave it empty or fetch from metadata
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-medium">
                              Zalecenia z dnia {format(new Date(rec.recommendation_date), "dd.MM.yyyy", { locale: pl })}
                            </p>
